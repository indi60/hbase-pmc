...
import org.apache.hadoop.hbase.master.RegionServerStartupData;
...
@org.ucare.cpn.annotations.Node
public class HRegionServer implements HRegionInterface, HBaseRPCErrorHandler,
  ...
  @org.ucare.cpn.annotations.EntryPoint
  public void run() {
    try {
  ...
  private MapWritable reportForDuty() throws IOException {
    ...
    try {
      ...
      RegionServerStartupData data = new RegionServerStartupData(port, this.startcode, now);
      result = this.hbaseMaster.regionServerStartup(data);
