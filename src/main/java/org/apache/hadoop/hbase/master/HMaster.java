...
Server {
  ...
  @Override
  @EntryPoint
  @org.ucare.cpn.annotations.RPC
  public MapWritable regionServerStartup(RegionServerStartupData data)
  throws IOException {
    // Register with server manager
    InetAddress ia = HBaseServer.getRemoteIp();
    ServerName rs = this.serverManager.regionServerStartup(ia, data.port,
    		data.serverStartCode, data.serverCurrentTime);
